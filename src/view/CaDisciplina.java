 ...
 * @author aluno
 */
public class CaDisciplina extends javax.swing.JFrame {

    /**
     * Creates new form CaDisciplina
     */
    public CaDisciplina() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label1.setText("Cadastrar Disciplina");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CaDisciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CaDisciplina().setVisible(true);
            }
        });
    }
